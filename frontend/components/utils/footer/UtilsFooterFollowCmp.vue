  ...
  <div>
    ...
    <div class="follow">
      ...
      <div @click="socialClick($event, 'https:t.me/mytikiapp', 'Telegram')">
        <utils-svg-cmp name="utils/footer/telegram" class="followBtn" />
      </div>
      <div
        @click="
          socialClick(
        ...
        "
      >
        <utils-svg-cmp name="utils/footer/signal" class="followBtn" />
      </div>
    </div>
  </div>
</template>
