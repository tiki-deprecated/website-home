...
import HeaderMoneyCmpAmt from '@/components/tmp/header_money/HeaderMoneyAmtCmp'
import HeaderMoneyCmpMake from '@/components/tmp/header_money/HeaderMoneyMakeCmp'

export default {
  name: 'HeaderMoneyCmp',
  components: { HeaderMoneyCmpAmt, UtilsSvgCmp, HeaderMoneyCmpMake },
}
</script>
...
.headerMoneyTopBkgHeader, .headerMoneyTopBkgHeaderLg
  position: absolute
  width: 100%
  top: 0
  left: 0
...
@include for-phone
  ...
  .headerMoneyTopBkgHeader
    height: 140%
    display: unset

  .headerMoneyTopBkgHeaderLg
    height: 0
    display: none

  ::v-deep .headerMoneyPineapple.svg
    height: 49%
