...
<template>
    <div class="w-full flex justify-between p-3 rounded-md" :class="type === BuilderState.LOADING ?'bg-tiki-yellow/20 border border-solid border-tiki-black/10' :
    'bg-tiki-red/20 border border-solid border-tiki-black/10'
    ">
        <div class="flex gap-2 justify-center items-center text-tiki-gray font-normal" :class="type === BuilderState.ERROR ? 'text-tiki-red' : ''">
            <img src="@/assets/images/loading-icon.svg" alt="" class="w-6" v-if="type === BuilderState.LOADING">
